...
cdef class Vector:
	...
	cpdef Vector copy(self):
		cdef Vector result = Vector(self.thisptr._len)
		cdef int i
	...
	def dist2(self, Vector other): return self.thisptr.dist2(py2cpp(other))
	def dist(self, Vector other): return self.thisptr.dist(py2cpp(other))
	def dist_inf(self, Vector other): return self.thisptr.dist_inf(py2cpp(other))

	def dot(self, Vector other): return self.thisptr.dot(py2cpp(other))
	def cross(self, Vector other): return cpp2py(self.thisptr.cross(py2cpp(other)))
...
@staticmethod
cdef Vector cpp2py(Point cpp_obj):
	py_obj = Vector(cpp_obj._len)
	cdef int i
...
@staticmethod
cdef Point py2cpp(Vector py_obj):
