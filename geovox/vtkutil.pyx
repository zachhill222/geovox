...
cdef class VtkVoxel:
	...
	cpdef int n(self, IndexIJK ijk):
		...
		elif (ijk[0]==0 and ijk[1]==1 and ijk[2]==0): return 2
		elif (ijk[0]==1 and ijk[1]==1 and ijk[2]==0): return 3
		elif (ijk[0]==0 and ijk[1]==0 and ijk[2]==1): return 4
		elif (ijk[0]==1 and ijk[1]==0 and ijk[2]==1): return 5
		elif (ijk[0]==0 and ijk[1]==1 and ijk[2]==1): return 6
		elif (ijk[0]==1 and ijk[1]==1 and ijk[2]==1): return 7
